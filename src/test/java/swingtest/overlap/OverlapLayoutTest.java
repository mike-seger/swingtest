...
public class OverlapLayoutTest {
	...
	static class DemoPanel extends JPanel implements ActionListener, MouseListener {
		...
		private void createLayout() {
			...
			Insets popupInsets = new Insets((Integer) top.getValue(), (Integer) left.getValue(),
					(Integer) bottom.getValue(), (Integer) right.getValue());
